        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#1e1e1e] rounded-xl shadow-md p-4">
              <div className="flex justify-between items-center">
                <select
                  ...
                  className="bg-[#2c2c2c] border border-gray-600 text-white py-2 px-3 rounded-lg"
                >
            ...
            <div className="bg-[#1e1e1e] rounded-xl shadow-md p-4">
              ...
              <div className="bg-[#2a2a2a] rounded-lg p-4 min-h-32 max-h-96 overflow-y-auto">
                {error ? (
                  <div className="text-red-400 bg-red-900 p-3 rounded">
                    {error}
                  </div>
                ) : analysisResult ? (
