    ...
    <div className="min-h-screen flex bg-gray-900 text-gray-200">
      ...
      >
        ...
        <div className="p-3 border-t border-gray-700">
          <motion.button className="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-gray-700 text-sm text-gray-400 hover:text-red-400 transition-colors" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
